...
* **Simultaneous Live Video Cube Mapping & Spatial Audio Mixing**: In 1997, simply decompressing a 128×128 video consumed a massive fraction of a Pentium CPU's compute power. The engine was texture-mapping that 266-frame live video stream onto multiple rotating faces of a 3D polygonal cube simultaneously—*while* concurrently calculating matrix transformations, Gouraud lighting, camera splines, sub-pixel polygon rasterization, software-mixing 16+ channels of digital tracker music, and computing real-time 3D spatial distance attenuation and stereo panning for voice effects on a single-core processor!
